...
def run_pipeline(params, progress_queue=None, control_queue=None):
    ...
    max_chunk_length = params.get('max_chunk_length', 60)
...
def main():
    ...
    parser.add_argument("--max-chunk-length", type=int, default=60, help="Maximum audio chunk length in seconds (default: 60)")
